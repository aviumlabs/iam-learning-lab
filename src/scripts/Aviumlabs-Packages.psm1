...
function Initialize-ApacheTomcat {
    ...
    $context_xml = "<Context path=""/"" docBase=""$env:CATALINA_BASE/webapps/identityiq""/>"
...
function Initialize-OpenSSH {
    ...
    if (-Not(Test-Path -Path $config_path)) {
        ...
        Write-Log -Message "OpenSSH already configured, not modifying."
    }
}
...
function Install-PostgreSQL {
    ...
    Write-Log -Message "Installing PostgreSQL..."
